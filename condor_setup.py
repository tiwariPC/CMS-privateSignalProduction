...
listOfFilesToTransfer = "NPS-BBDM_GEN-Run3Summer22wmLHEGS_1_cfg.py, NPS-BBDM_GEN-Run3Summer22DRPremix_1_cfg.py, NPS-BBDM_GEN-Run3Summer22DRPremix_2_cfg.py, NPS-BBDM_GEN-Run3Summer22MiniAODv4_1_cfg.py, NPS-BBDM_GEN-Run3Summer22NanoAODv12_1_cfg.py, dummyFile"
...
outScript.write("\n" + "ls *.root")
outScript.write("\n" + 'echo "+=============================="')
outScript.write("\n" + 'echo "==> cmsRun NPS-BBDM_GEN-Run3Summer22DRPremix_1_cfg.py" ')
outScript.write("\n" + "cmsRun NPS-BBDM_GEN-Run3Summer22DRPremix_1_cfg.py  ")
outScript.write("\n" + 'echo "+=============================="')
outScript.write("\n" + 'echo "List all root files = "')
outScript.write("\n" + "ls *.root")
outScript.write("\n" + 'echo "+=============================="')
...
outScript.write("\n" + "ls *.root")
outScript.write("\n" + 'echo "+=============================="')
outScript.write("\n" + 'echo "==> cmsRun NPS-BBDM_GEN-Run3Summer22NanoAODv12_1_cfg.py"')
outScript.write("\n" + "cmsRun NPS-BBDM_GEN-Run3Summer22NanoAODv12_1_cfg.py")
outScript.write("\n" + 'echo "+=============================="')
outScript.write("\n" + 'echo "List all root files = "')
outScript.write("\n" + "ls *.root")
outScript.write("\n" + 'echo "+=============================="')
outScript.write("\n" + "mv NPS-BBDM_GEN-Run3Summer22NanoAODv12.root  NPS-BBDM_GEN-Run3Summer22NanoAODv12_${4%%/*}_${1}_${2}.root")
outScript.write("\n" + 'echo "Do xrdcp output for condor"')
outScript.write("\n" + 'outfile="NPS-BBDM_GEN-Run3Summer22NanoAODv12_${4%%/*}_${1}_${2}.root"')
