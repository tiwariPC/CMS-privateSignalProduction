...
outScript.write("\n" + "ls *.root")
outScript.write("\n" + 'echo "+=============================="')
outScript.write("\n" + "mv NPS-BBDM-RunIII2024Summer24NanoAODv15.root  BBDM-2HDMa-fullsim_Par-LO-5f_TuneCP5_13p6TeV_madgraph-pythia8_NanoAODv15_${1}_${2}.root")
outScript.write("\n" + 'echo "Do xrdcp output for condor"')
outScript.write("\n" + 'outfile="BBDM-2HDMa-fullsim_Par-LO-5f_TuneCP5_13p6TeV_madgraph-pythia8_NanoAODv15_${1}_${2}.root"')
