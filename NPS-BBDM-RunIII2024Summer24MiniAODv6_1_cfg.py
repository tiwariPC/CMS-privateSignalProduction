...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:NPS-BBDM-RunIII2024Summer24DRPremix.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('--era nevts:600'),
...
process.MINIAODSIM1output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:NPS-BBDM-RunIII2024Summer24MiniAODv6.root'),
