...
cd /afs/cern.ch/cms/PPD/PdmV/work/McM/submit/GEN-Run3Summer22MiniAODv4/
...
# Dump actual test code to a GEN-Run3Summer22MiniAODv4_test.sh file that can be run in Singularity
cat <<'EndOfTestFile' > GEN-Run3Summer22MiniAODv4_test.sh
#!/bin/bash
...
# cmsDriver command
cmsDriver.py  --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --conditions 130X_mcRun3_2022_realistic_v5 --step PAT --geometry DB:Extended --era Run3,run3_miniAOD_12X --python_filename GEN-Run3Summer22MiniAODv4_1_cfg.py --fileout file:GEN-Run3Summer22MiniAODv4.root --filein "dbs:/Zto2Nu-2Jets_PTNuNu-40to100_2J_TuneCP5_13p6TeV_amcatnloFXFX-pythia8/Run3Summer22DRPremix-124X_mcRun3_2022_realistic_v12-v1/AODSIM" --number 600 --number_out 600 --no_exec --mc || exit $? ;

# End of GEN-Run3Summer22MiniAODv4_test.sh file
EndOfTestFile

# Make file executable
chmod +x GEN-Run3Summer22MiniAODv4_test.sh
...
singularity run --no-home /cvmfs/unpacked.cern.ch/registry.hub.docker.com/cmssw/$CONTAINER_NAME $(echo $(pwd)/GEN-Run3Summer22MiniAODv4_test.sh)
