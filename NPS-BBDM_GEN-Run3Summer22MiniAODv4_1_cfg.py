...
# with command line options: --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --conditions 130X_mcRun3_2022_realistic_v5 --step PAT --geometry DB:Extended --era Run3,run3_miniAOD_12X --python_filename NPS-BBDM_GEN-Run3Summer22MiniAODv4_1_cfg.py --fileout file:NPS-BBDM_GEN-Run3Summer22MiniAODv4.root --filein NPS-BBDM_GEN-Run3Summer22DRPremix.root --number 600 --number_out 600 --no_exec --mc
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:NPS-BBDM_GEN-Run3Summer22DRPremix.root' ),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:NPS-BBDM_GEN-Run3Summer22MiniAODv4.root'),
